...
final class CachedBluetoothDevice implements Comparable<CachedBluetoothDevice> {
	...
	/** Whether clicked the Botton "Cancel" of Pairing Dialog. */
	private boolean mPairingDialogCancelled;
    /**
    ...
    CachedBluetoothDevice(Context context,
		...
		setPairingDialogCancelled(false);
        fillData();
    }
    ...
    //click the cancell botton of pairing dialog
	public void setPairingDialogCancelled(boolean cancelled) {
		   
         mPairingDialogCancelled = cancelled;
	}

    public boolean getPairingDialogCancelled() {

		 return mPairingDialogCancelled;
	}
