...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    private static final int FALLBACK_TV_MODE_VALUE = 0;		//HDC 20141111;
    private static final int FALLBACK_TV_RESOLUTION_VALUE = 720960;
    ...
    private static final String KEY_TV_MODE = "tv_mode";		//hdc 20141111;
	...
	ListPreference tvModePreference =
        ...
        tvModePreference.setOnPreferenceChangeListener(this);		//hdc 20141111
...
*/
	...
	mHdmiService.initHdmiService();		//hdc 20141111;
	...
	if (KEY_TV_MODE.equals(key)) {
            ...
            try {
                Settings.System.putInt(getContentResolver(),
                        TV_MODE, value);
String tvmodes = ""+ value;
System.out.printf("hdc setHdmi tv_mode: %d,tvmodes: %s\n",value,tvmodes);
SystemProperties.set("persist.sys.hdmi.tvmode",tvmodes);	//hdc 20141113;
            } catch (NumberFormatException e) {
	...
	if (KEY_TV_RESOLUTION.equals(key)) {
            ...
            try {
                Settings.System.putInt(getContentResolver(),
                        TV_RESOLUTION, value);
String resolutions = ""+ value;
System.out.printf("hdc setHdmi resolution: %d,resolutions: %s\n",value,resolutions);
SystemProperties.set("persist.sys.hdmi.resolution",resolutions);	//hdc 20141113;
            } catch (NumberFormatException e) {
	...
	if (KEY_TV_HDCP.equals(key)) {
            ...
            try {
                Settings.System.putInt(getContentResolver(),
                        TV_HDCP, value);
String tvhdcps = ""+ value;
System.out.printf("hdc setHdmi tv_hdcp: %d,tvhdcps: %s\n",value,tvhdcps);
SystemProperties.set("persist.sys.hdmi.tvhdcp",tvhdcps);	//hdc 20141113;
            } catch (NumberFormatException e) {
                Log.e(TAG, "could not persist tv resolution setting", e);
            }
